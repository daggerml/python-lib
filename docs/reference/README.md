...
Use this section when you need exact details about the user-facing surfaces DaggerML exposes today.

- [Python API](python-api.md): package exports, `Dml`, DAG helpers, and node wrappers.
- [CLI](cli.md): generated `dml` commands, namespaces, flags, input parsing, and output behavior.
