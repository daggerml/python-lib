---
title: "Flaky CI Investigation: Execution Cancellation and Docker over SSH"
engine: knitr
---
...
<!-- docs:pseudocode: observed assertion output from the investigated CI failure. -->
```text
...
<!-- docs:pseudocode: observed exception output from the investigated CI failure. -->
```text
...
<!-- docs:pseudocode: recorded local verification output, not a build command. -->
```text
1 passed in 11.85s
```
