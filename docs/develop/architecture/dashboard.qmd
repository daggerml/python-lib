...
titles rather than filesystem labels, and provides a local page filter. Only
the current reader path and the introductory path are expanded by default so
the complete inventory remains available without dominating the page.
