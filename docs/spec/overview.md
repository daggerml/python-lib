...
| Contrib runtime lifecycle | `docs/contrib/runtime-contract.md`, `docs/contrib/executor-state.md`, `docs/contrib/executor-catalog.md`, `docs/contrib/execution-graph.md` | Supervisor launch, executor start/poll/cleanup, `ExecutionState` transitions, adapter/executor pairing, and any deployment-specific execution-graph behavior. |
