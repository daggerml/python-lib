"""Manage a local moto server and a sourceable environment file for docs.

This helper owns the infra lifecycle for moto-backed documentation scripts. It keeps
