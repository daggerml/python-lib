...
<!-- docs:pseudocode: These entry points reference reader-defined classes in an installable integration package. -->
```toml
...
<!-- docs:pseudocode: This codec entry point names a reader-defined installed factory. -->
```toml
...
<!-- docs:pseudocode: This dashboard entry point names a reader-defined installed provider. -->
```toml
