...
<!-- docs:pseudocode: This protocol declaration is a type-level API reference, not a complete executable implementation. -->
```python
...
<!-- docs:pseudocode: This is a rendered graph trace, not authored runnable source. -->
```text
