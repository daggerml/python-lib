...
<!-- docs:pseudocode: This codec requires a reader-defined package and Decimal import; it is an implementation template rather than an isolated integration. -->
```python
class DecimalCodec:
...
<!-- docs:pseudocode: This package metadata must be installed before DaggerML can discover the reader-defined codec factory. -->
```toml
