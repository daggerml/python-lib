...
Use [author a DAG](author-a-dag.qmd) for the current Python authoring pattern and [refresh cached work](refresh-cache.qmd) when intentionally recomputing a result.
