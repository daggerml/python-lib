...
Use a custom codec when your Python type needs a repeatable stored representation. See [artifacts](../guides/artifacts.qmd) and [custom codecs](../guides/custom-codecs.qmd).
