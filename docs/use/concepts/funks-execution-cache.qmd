...
Use [author a DAG](../guides/author-a-dag.qmd) for the current Python authoring pattern and [refresh cached work](../guides/refresh-cache.qmd) when intentionally recomputing a result.
