...
<!-- docs:pseudocode: This package metadata names an installed provider and cannot be applied by an isolated page. -->
```toml
...
<!-- docs:pseudocode: This provider runs only after its package is installed in the dashboard process and a tagged DAG is selected. -->
```python
...
- [Plugin API](../../extend/reference/plugin-api.qmd)
- [DAG storage and types](../../develop/architecture/dag-storage-and-types.qmd)
