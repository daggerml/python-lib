...
### Requirement: Index model refactor does not change stage-one workflow semantics
This change SHALL preserve the current external runtime and history behavior while refactoring the internal model.
