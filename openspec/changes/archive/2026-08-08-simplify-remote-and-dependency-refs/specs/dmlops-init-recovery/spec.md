...
**Reason**: Recovery capability is selected by `remote.root`; project URIs no longer exist.
**Migration**: Persist `remote.root` when missing-DB recovery should bootstrap remote state.
