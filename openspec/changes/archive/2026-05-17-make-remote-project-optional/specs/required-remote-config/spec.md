...
- **THEN** it receives already-resolved remote configuration from its caller instead of inspecting raw remote environment variables or project config files directly
